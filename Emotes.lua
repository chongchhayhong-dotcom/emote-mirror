--[[
    ...
    Original source: https://github.com/7yd7/Hub (Branch/GUIS/Emotes.lua)
    Base emote code derived from Roblox creator docs:
        https://github.com/Roblox/creator-docs/blob/main/content/en-us/characters/emotes.md
    scriptblox page: https://scriptblox.com/script/Universal-Script-7yd7-I-Emote-Script-48024

    Mirror changes:
      * All remotely-loaded Lua files (Notify/Settings/OpenEmote) are now
        fetched from THIS repository (lib/ folder) instead of the author's repos,
        so the author cannot push a malicious update later.
      * Emote/animation JSON data is fetched from data/ in THIS repository.
      * No other code changed. No backdoors, credential stealers, or
        purchase prompts were found in the audited files (see SECURITY.md).
]]
...
-- ============================================================
-- [MIRROR] Community mirror - base URL for this script's own files.
-- Change these two values to YOUR GitHub username and repo name.
...
-- [EMBEDDED] Notify.lua (was fetched from GitHub, now embedded to avoid 404)
do
local Players = game:GetService("Players")
...
-- [EMBEDDED] Settings.lua - embedded to avoid 404
local SettingsLib = (function()
local TweenService = game:GetService("TweenService")
local UserInputService = game:GetService("UserInputService")
local RunService = game:GetService("RunService")
local Players = game:GetService("Players")
...
-- End embedded OpenEmote.lua
-- Original returned value not needed (it creates button itself)
