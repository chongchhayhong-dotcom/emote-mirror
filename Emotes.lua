...
SafeLoad(MirrorPath("Notify.lua"), "Notify System")
...
local SettingsLib = SafeLoad(MirrorPath("Settings.lua"), "Settings Library")
...
if UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled then
    SafeLoad(MirrorPath("OpenEmote.lua"), "Open Emote")
    getgenv().Notify({
